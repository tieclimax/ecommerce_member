...
class PostCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('superadmin.postcategory.index')->with('postCategories', $postCategory);
    }
    ...
    {
        return view('superadmin.postcategory.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.postcategory.edit')->with('postCategory', $postCategory);
    }
