...
class PostTagController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('superadmin.posttag.index')->with('postTags', $postTag);
    }
    ...
    {
        return view('superadmin.posttag.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.posttag.edit')->with('postTag', $postTag);
    }
