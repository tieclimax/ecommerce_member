...
@section('title', 'TopShop || Check Out page')
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>ที่อยู่บรรทัดที่ 1<span>*</span></label>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>ที่อยู่บรรทัดที่ 2</label>
                                    ...
                                    <ul>
                                        ...
                                        @if (session('coupon'))
                                            <li class="last" id="order_total_price">
                                                รวมทั้งหมด<span>฿{{ number_format($total_amount, 2) }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                รวมทั้งหมด<span>฿{{ number_format($total_amount, 2) }}</span></li>
                                        @endif
