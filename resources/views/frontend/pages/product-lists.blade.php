...
@section('title', 'TopShop || PRODUCT PAGE')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">รายการสินค้า</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                            ...
                            <div class="single-widget range">
                                <h3 class="title">เลือกซื้อตามราคา</h3>
                                <div class="price-filter">
                                    <div class="price-filter-inner">
                                        ...
                                        <div class="product_filter">
                                            <button type="submit" class="filter_button">กรองราคา</button>
