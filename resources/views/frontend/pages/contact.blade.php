...
@section('title', 'TopShop || Contact page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">ติดต่อเรา</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            <div class="title">
                                ...
                                @endphp
                                <h4>ติดต่อเรา</h4>
                            <h3>เขียนข้อความถึงเรา @auth @else<span style="font-size:12px;" class="text-danger">[
                                    คุณต้องเข้าสู่ระบบก่อน]</span>@endauth</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="name" id="name" type="text" placeholder="ใส่ชื่อของคุณ...">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>หัวข้อ<span>*</span></label>
                                        <input name="subject" type="text" id="subject" placeholder="ใส่หัวเรื่อง...">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>อีเมลของคุณ<span>*</span></label>
                                        <input name="email" type="email" id="email" placeholder="ป้อนที่อยู่อีเมล...">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>เบอร์โทรศัพท์<span>*</span></label>
                                        <input id="phone" name="phone" type="number" placeholder="ใส่โทรศัพท์ของคุณ...">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group message">
                                        ...
                                        <textarea name="message" id="message" cols="30" rows="9"
                                            placeholder="ใส่ข้อความของคุณ..."></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group button">
                                        <button type="submit" class="btn ">ส่งถึงเรา</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="text-success">ขอบคุณ!</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p class="text-success">ส่งข้อความของคุณเรียบร้อยแล้ว...</p>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="text-warning">ขออภัย!</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p class="text-warning">มีบางอย่างผิดพลาด</p>
            </div>
        </div>
    </div>
</div>
