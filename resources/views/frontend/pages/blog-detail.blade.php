...
@section('title', 'TopShop || Blog Detail page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">บล็อก</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>โดย
                                                {{ $post->author_info['name'] }}</a><a href="javascript:void(0);"><i
                                                    class="fa fa-calendar"></i>{{ $post->created_at->format('M d, Y') }}</a><a
                                                href="javascript:void(0);"><i class="fa fa-comments"></i>แสดงความคิดเห็น
                                ...
                                <div class="col-12 mt-4">
                                    <div class="reply">
                                        <div class="reply-head comment-form" id="commentFormContainer">
                                            <h2 class="reply-title">ทิ้งข้อความไว้</h2>
                                            <!-- Comment Form -->
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group button">
                                                            <button type="submit" class="btn"><span
                                                                    class="comment_btn comment">เขียนความคิดเห็น</span><span
                                                                    class="comment_btn reply"
                                                                    style="display: none;">ตอบความคิดเห็น</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            @else
                                <p class="text-center p-5">
                                    คุณต้อง <a href="{{ route('login.form') }}"
                                        style="color:rgb(54, 54, 204)">เข้าสู่ระบบ</a>
                                    หรือ
                                    <a style="color:blue" href="{{ route('register.form') }}">สมัครสมาชิก</a>
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">ความคิดเห็น ({{ $post->allComments->count() }})</h3>
                                    <!-- Single Comment -->
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">หมวดหมู่บล็อก</h3>
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">จดหมายข่าว</h3>
                            <div class="letter-inner">
                                <h4>สมัครและรับข่าวสาร <br> อัพเดทล่าสุด</h4>
                                <form method="POST" action="{{ route('subscribe') }}" class="form-inner">
                                    @csrf
                                    <input type="email" name="email" placeholder="Enter your email">
                                    <button type="submit" class="btn " style="width: 100%; margin-top:5px">ส่ง</button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->
