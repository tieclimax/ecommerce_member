...
@endsection
@section('title', 'TopShop || PRODUCT DETAIL')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="">รายละเอียดร้านค้า</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-des">
                                ...
                                <div class="short">
                                    ...
                                    @endphp
                                    <p class="price"><span
                                            class="discount">฿{{ number_format($after_discount, 2) }}</span><s>฿{{($product_detail->price, 2) }}</s>
                                    </p>
                                ...
                                <div class="product-buy">
                                    ...
                                    @endif
                                    <p class="availability">คลังสินค้า : @if ($product_detail->stock > 0)<span
                                ...
                                <div class="nav-main">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                href="#description" role="tab">คำอธิบาย</a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reviews"
                                                role="tab">รีวิวสินค้า</a></li>
                                    </ul>
                                    <!--/ End Tab Nav -->
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="comment-review">
                                                        ...
                                                        <h4>คะแนนของคุณ <span class="text-danger">*</span></h4>
                                                        <div class="review-inner">
                                                            ...
                                                            @else
                                                                <p class="text-center p-5">
                                                                    คุณต้อง <a href="{{ route('login.form') }}"
                                                                        style="color:rgb(54, 54, 204)">เข้าสู่ระบบ</a> หรือ <a
                                                                        style="color:blue"
                                                                        href="{{ route('register.form') }}">สมัครสมาชิก</a>
                                                    ...
                                                    <div class="ratting-main">
                                                        <div class="avg-ratting">
                                                            ...
                                                            <span>ทั้งหมด {{ $product_detail->getReview->count() }}
                                                                ความคิดเห็น</span>
                                                        </div>
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View"
                                                    href="#"><i class=" ti-eye"></i><span>ดูร้านค้า</span></a>
                                                <a title="Wishlist" href="#"><i
                                                        class=" ti-heart "></i><span>เพิ่มไปยังสิ่งที่ชอบ</span></a>
                                                <a title="Compare" href="#"><i
                                                        class="ti-bar-chart-alt"></i><span>เพิ่มเปรียบเทียบ</span></a>
                                            </div>
                                            <div class="product-action-2">
                                                <a title="Add to cart" href="#">เพิ่มไปยังตะกร้า</a>
                                            </div>
                                        </div>
                                    </div>
