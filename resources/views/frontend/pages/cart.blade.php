...
@section('title', 'TopShop || Cart page')
                                ...
                                @else
                                    <tr>
                                        <td class="text-center">
                                            ไม่มีสินค้าในตะกร้า <a href="{{ route('product-grids') }}"
                                                style="color:blue;">ช้อปปิ้งต่อ</a>
                        ...
                        <div class="row">
                                ...
                                <div class="left">
                                    <div class="coupon">
                                        <form action="{{ route('coupon-store') }}" method="POST">
                                            @csrf
                                            <input name="code" placeholder="ใส่คูปองของคุณ...">
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="coupon_price" data-price="{{ Session::get('coupon')['value'] }}">
                                                ประหยัดไป<span>฿{{ number_format(Session::get('coupon')['value'], 2) }}</span>
                                            </li>
                                        @endif
                                        @php
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="last" id="order_total_price">
                                                จ่าย<span>฿{{ number_format($total_amount, 2) }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                จ่าย<span>฿{{ number_format($total_amount, 2) }}</span></li>
                                        @endif
                                    ...
                                    <div class="button5">
                                        <a href="{{ route('checkout') }}" class="btn">ชำระเงิน</a>
                                        <a href="{{ route('product-grids') }}" class="btn">ช้อปปิ้งต่อ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
