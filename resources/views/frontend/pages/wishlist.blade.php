...
@section('title', 'TopShop || Wishlist page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">สินค้าที่ชอบ</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table shopping-summery">
                        <thead>
                            <tr class="main-hading">
                                ...
                                <th class="text-center">เพิ่มลงในตะกร้า</th>
                                ...
                                @foreach (Helper::getAllProductFromWishlist() as $key => $wishlist)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('add-to-cart', $wishlist->product['slug']) }}"
                                                class='btn text-white'>เพิ่มลงในตะกร้า</a></td>
                            ...
                            @else
                                <tr>
                                    <td class="text-center">
                                        ไม่มีสินค้าที่คุณชอบในรายการ <a href="{{ route('product-grids') }}"
