...
@section('title', 'TopShop || HOME PAGE')
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a data-toggle="modal" data-target="#{{ $product->id }}"
                                                            title="ดูเลย" href="#"><i
                                                                class=" ti-eye"></i><span>ดูร้านค้า</span></a>
                                                        <a title="ชอบ"
                                                            href="{{ route('add-to-wishlist', $product->slug) }}"><i
                                                                class=" ti-heart "></i><span>เพิ่มเข้าในรายการที่ต้องการ</span></a>
                                                    </div>
                                                    <div class="product-action-2">
                                                        <a title="เพิ่มไปยังตะกร้า"
                                                            href="{{ route('add-to-cart', $product->slug) }}">เพิ่มไปยังตะกร้า</a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            @if ($product->condition == 'hot')
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#{{ $product->id }}" title="ดูเลย"
                                                    href="#"><i class=" ti-eye"></i><span>ดูร้านค้า</span></a>
                                                <a title="ชอบ" href="{{ route('add-to-wishlist', $product->slug) }}"><i
                                                        class=" ti-heart "></i><span>เพิ่มเข้าในรายการที่ต้องการ</span></a>
                                            </div>
                                            <div class="product-action-2">
                                                <a href="{{ route('add-to-cart', $product->slug) }}">เพิ่มไปยังตะกร้า</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                                            <div class="content">
                                                ...
                                                @if ($product->discount != null)
                                                    <del style="">฿
                                                        {{ number_format($product->price, 2) }}</del><br>
                                                @endif
                                                @php
                                                    $after_discount = $product->price - ($product->price * $product->discount) / 100;
                                                @endphp
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> ({{ $rate_count }} ความคิดเห็นของลูกค้า)</a>
                                            </div>
