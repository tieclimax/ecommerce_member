    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('settings.update') }}">
                ...
                <div class="form-group">
                    <label for="description" class="col-form-label"> คำอธิบาย <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label for="email" class="col-form-label"> อีเมล <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label for="phone" class="col-form-label"> หมายเลขโทรศัพท์ <span class="text-danger">*</span></label>
