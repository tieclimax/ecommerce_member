...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{ route('superadmincoupon.create') }}" class="btn btn-primary btn-sm float-right"
                data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Coupon</a>
        </div>
        <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('superadmincoupon.edit', $coupon->id) }}"
