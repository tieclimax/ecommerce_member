...
@section('main-content')
    ...
    <div class="card">
        <h5 class="card-header">เพิ่มการจัดส่ง</h5>
        <div class="card-body">
            <form method="post" action="{{ route('shipping.store') }}">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="inputTitle" class="col-form-label">ประภท <span class="text-danger">*</span></label>
                    <input id="inputTitle" type="text" name="type" placeholder="กรอกประเภทการจัดส่ง"
                ...
                <div class="form-group">
                    ...
                    <input id="price" type="number" name="price" placeholder="กรอกราคา" value="{{ old('price') }}"
                        class="form-control">
                    @error('price')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
