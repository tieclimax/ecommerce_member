    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <form class="border px-4 pt-2 pb-3 rounded" method="POST"
                            ...
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <a id="lfm" data-input="thumbnail" data-preview="holder"
                                        class="btn btn-primary text-light"> เลือก
                                    </a>
                                </span>
                        ...
                        <button type="submit" class="btn btn-success btn-sm mt-3">อัปเดต</button>
                    </form>
                </div>
            </div>
        </div>
